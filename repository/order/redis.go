...
import (
	...
	"github.com/evan3v4n/Go-lang--Microservice/model"
)
...
var ErrNotExist = errors.New("errors not exist")
...
// Findall
// Inefficient to load ALL order's at once so we will parse/break them down into a few pages
